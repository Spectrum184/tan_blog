...
const Footer: FC = () => {
  return (
    <footer className="flex flex-wrap items-center justify-between p-2 m-auto bottom-0">
      <div className="container mx-auto flex flex-col flex-wrap items-center justify-between border-t border-green-500 max-w-screen-xl">
        <ul className="flex mx-auto text-green-500 text-center">
        ...
        <div className="flex mx-auto text-green-500 text-center">
          Bản quyền thuộc về ThanhTK © 2021
        </div>
      </div>
    </footer>
  );
